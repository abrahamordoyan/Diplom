...
<header>
  ...
  <div class="content-container">
    <h1>Музей заповедник</h1>
    <img src="images/places/zapovednik.jpg" alt="Музей заповедник" class="place-image">
    
    <h2>История:</h2>
    <p class="place-description">
    Ярославский музей-заповедник относится к крупнейшим культурным учреждениям области и к старейшим музеям на территории РФ. Входящие в его состав движимые и недвижимые объекты связаны с историческим прошлым, архитектурой и культурой Ярославской земли. Административные службы и основные музейные экспозиции располагаются в границах комплекса Спасо-Преображенского монастыря, где находятся древнейшие строения города.    </p>

    <h3>Архитектура и особенности:</h3>
    <p class="place-description">
    Главной жемчужиной музея является Спасо-Преображенский собор, построенный в 1516 году. Это выдающийся памятник архитектуры, в котором сохранились древние фрески и мозаики.
      </p>
  ...
  <script type="text/javascript">
    ...
    ymaps.ready(function () {
      var map = new ymaps.Map("map", {
        center: [57.621637, 39.888574], // Координаты Собора Ильи Пророка
        zoom: 16,
      });

      // Создание метки на карте
      var placemark = new ymaps.Placemark([57.621637, 39.888574], {
        balloonContent: "Музей заповедник", // Текст метки
      }, {
