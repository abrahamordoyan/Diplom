...
<head>
  ...
  <title>Парк 1000-летия Ярославля</title>
...
<header>
  ...
  <div class="content-container">
    <h1>Парк 1000-летия Ярославля</h1>
    <img src="images/places/park-1000.jpg" alt="Парк 1000-летия Ярославля" class="place-image">
    
    <h2>История:</h2>
    <p class="place-description">
    Парк 1000-летия Ярославля был открыт в 2010 году в честь тысячелетия города. Этот парк стал важным культурным и рекреационным центром города, привлекающим не только местных жителей, но и туристов. В парке проходят различные культурные мероприятия, фестивали и выставки.    </p>

    <h3>Архитектура и особенности:</h3>
    <p class="place-description">
    Парк располагается на берегу реки Волги и имеет несколько тематических зон, включая прогулочные дорожки, площадки для отдыха и детские игровые зоны. В центре парка стоит памятник Ярославу Мудрому — князю, который основал город.    </p>
  ...
  <script type="text/javascript">
    ...
    ymaps.ready(function () {
      var map = new ymaps.Map("map", {
        center: [57.617295, 39.871400], // Координаты Собора Ильи Пророка
        zoom: 16,
      });

      // Создание метки на карте
      var placemark = new ymaps.Placemark([57.617295, 39.871400], {
        balloonContent: "Парк 1000-летия Ярославля", // Текст метки
      }, {
